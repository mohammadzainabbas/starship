...
# 
# ``` (inside ~/.zshrc)
# # Setup zsh to use Starship i.e: eval "$(starship init zsh)"
...
# Check (https://github.com/starship/starship/blob/master/src/init/starship.zsh) for startup script for zsh shell
